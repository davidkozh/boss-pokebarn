...
window.POKEBARN_TASKS = [
  ...
  { id: 'moysklad-purchase-prices',    name: 'Закупочные цены',           icon: '💰', hour: 4,    enabled: true,  agent: 'продакт', desc: 'Обновление закупочных цен из заказов поставщикам (1/3)' },
  ...
  { id: 'ozon-promo-audit',            name: 'Акции Ozon',                icon: '🏷️', hour: 4.5,  enabled: false, agent: 'продакт', desc: 'Мониторинг акций Ozon, коррекция цен и удаление' },
  ...
  { id: 'wb-promo-audit',              name: 'Акции WB',                  icon: '🏷️', hour: 5,    enabled: false, agent: 'продакт', desc: 'Мониторинг участия товаров в акциях WB' },
  ...
  { id: 'backup-prompts-readme',       name: 'Бэкап промптов',            icon: '💾', hour: 8,    enabled: true,  agent: 'авто',    desc: 'Бэкап README-файлов и prompts/' },
  { id: 'moysklad-purchase-prices',    name: 'Закупочные цены',           icon: '💰', hour: 12,   enabled: true,  agent: 'продакт', desc: 'Обновление закупочных цен из заказов поставщикам (2/3)' },
  { id: 'backup-prompts-readme',       name: 'Бэкап промптов',            icon: '💾', hour: 14,   enabled: true,  agent: 'авто',    desc: 'Бэкап README-файлов и prompts/' },
  { id: 'moysklad-purchase-prices',    name: 'Закупочные цены',           icon: '💰', hour: 20,   enabled: true,  agent: 'продакт', desc: 'Обновление закупочных цен из заказов поставщикам (3/3)' },
  { id: 'backup-prompts-readme',       name: 'Бэкап промптов',            icon: '💾', hour: 20,   enabled: true,  agent: 'авто',    desc: 'Бэкап README-файлов и prompts/' },
